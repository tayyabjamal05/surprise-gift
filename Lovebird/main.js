...
async function placeOrder(customerName, whatsapp, message, productName, isMobileDevice) {
    try {
        ...
        // D. Redirect to WhatsApp immediately
...
orderForm.addEventListener('submit', async (e) => {
    ...
    await placeOrder(customerName, whatsapp, message, productName, isMobileDevice);
});
